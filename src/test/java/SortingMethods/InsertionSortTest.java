...
public class InsertionSortTest {
    ...
    public void insertionSort() {
        ...
        InsertionSort.insertionSort(arr_7);
        ...
        InsertionSort.insertionSort(arr_8);
        assertArrayEquals(arr_8, arrResult_8);

        int[] arr_9 = {0, -1};
        int[] arrResult_9 = {-1, 0};
        InsertionSort.insertionSort(arr_9);
        assertArrayEquals(arr_9, arrResult_9);

        int[] arr_10 = {-1, -3, -2};
        int[] arrResult_10 = {-3, -2, -1};
        InsertionSort.insertionSort(arr_10);
